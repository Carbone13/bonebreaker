...
public struct sfloat2 
{
    ...
    public static sfloat2 Lerp (sfloat2 firstFloat, sfloat2 secondFloat, sfloat by)
    {
        sfloat x = sfloat.Lerp(firstFloat.X, secondFloat.X, by);
        sfloat y = sfloat.Lerp(firstFloat.Y, secondFloat.Y, by);
    ...
    public static sfloat2 operator - (sfloat2 one, sfloat two)
    {
        return new sfloat2(one.X - two, one.Y - two);
    }
